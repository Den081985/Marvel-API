...
и импортируем  экземпляр класса App*/ // const API_URL = "https://gateway.marvel.com/v1/public/comics";
...
(async ()=>{
    ...
    _comicsDefault.default.eventListener();
})();

},{"../src/components/App/app":"8kJ42","./components/Comics":"lqmjS","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"8kJ42":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
Импортируем app.css и класс Comics */ var _comics = require("../Comics");
var _comicsDefault = parcelHelpers.interopDefault(_comics);
var _appCss = require("./app.css");
class App {
    async render() {
        await _comicsDefault.default.render();
    }
}
exports.default = new App();

},{"../Comics":"lqmjS","./app.css":"gcdXF","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"lqmjS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Создаем ссылку на экспорт файла Comics
parcelHelpers.export(exports, "default", ()=>_comicsDefault.default
);
var _comics = require("./Comics");
var _comicsDefault = parcelHelpers.interopDefault(_comics);

},{"./Comics":"8mKgD","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"8mKgD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
асинхронную функцию с методом getData запроса на сервер(репозиторий) */ /*Из полученных данных необходимо выбрать поля id, title, thumbnail(содержит путь к 
    изображению(path) и расширение(extension)) 
    data- атрибут в html-элементе является пользовательским и может быть установлен.
    пользовательские данные доступны через HTMLElementинтерфейс элемента, для которого установлен атрибут. */ var _api = require("../../../constants/api");
...
class Comics {
    renderComics(data) {
        ...
        data.forEach(({ id , title , thumbnail: { path , extension  }  })=>{
            if (path.lastIndexOf(_api.IMG_NOT_AVAILABLE) === -1) {
                ...
                const uri = _api.API_URL + _api.URL_COMICS + "/" + id + "/" + _api.URL_CHARACTERS;
  ...
  получения данных рендерим их в корневой элемент,в случае ошибки-вызываем Error.render()  */ async render() {
        const data = await _getDataApi.getDataApi.getData(_api.API_URL + _api.URL_COMICS);
        if (data) this.renderComics(data);
        else _errorDefault.default.render();
...
каждого элемента,содержащий путь к персонажам комикса*/ eventListener() {
        document.querySelectorAll(".comics__item").forEach((element)=>{
            const uri = element.getAttribute("data-uri");
            element.addEventListener("click", ()=>{
                _charactersDefault.default.render(uri);
            });
        });
    }
}
...
},{"../../../constants/api":"fp8km","../../utils/getDataApi":"c6DGo","../../../constants/root":"cKJfz","./Comics.css":"lfpJ4","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","../Error":"XfmKd","../Characters/Characters":"eiHK9"}],"fp8km":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"c6DGo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
и создаем экземпляр класса. */ var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _api = require("../../constants/api");
class GetDataApi {
    async getData(url) {
        try {
            const response = await _axiosDefault.default.get(url, {
                params: {
                    apikey: _api.API_KEY,
                    limit: 100
                }
...
},{"axios":"1IeuP","../../constants/api":"fp8km","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"1IeuP":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"lfpJ4":[function(require,module,exports) {
module.exports["comics__container"] = "_comics__container_ce6070";
module.exports["comics__item"] = "_comics__item_ce6070";
module.exports["comics__name"] = "_comics__name_ce6070";
module.exports["comics__img"] = "_comics__img_ce6070";

},{}],"XfmKd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>_errorDefault.default
);
var _error = require("./Error");
var _errorDefault = parcelHelpers.interopDefault(_error);

},{"./Error":"kyZeG","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"kyZeG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"eiHK9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/*Создаем класс для получения персонажей комикса и рендеринга на страницу */ // Импортируем экземпляр класса с методом для запроса(getData)
var _getDataApi = require("../../utils/getDataApi");
...
class Characters {
    ...
    async render(uri) {
        const data = await _getDataApi.getDataApi.getData(uri);
        /*if (data.length) {
      this.renderContent();
    } else {
      this.renderNotification();
    }*/ //Запись проверки тернарным оператором
        data.length ? this.renderContent(data) : _notificationDefault.default.render();
    }
}
exports.default = new Characters();

},{"../../utils/getDataApi":"c6DGo","../../../constants/root":"cKJfz","../../../constants/api":"fp8km","./Characters.css":"c5HkN","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","./img/icons8-удалить.svg":"1AiNH","../Notification/Notification":"e6GWD"}],"c5HkN":[function(require,module,exports) {
module.exports["wrapper"] = "_wrapper_a9fe0b";
module.exports["characters__container"] = "_characters__container_a9fe0b";
module.exports["characters__item"] = "_characters__item_a9fe0b";
module.exports["characters__img"] = "_characters__img_a9fe0b";
module.exports["characters__name"] = "_characters__name_a9fe0b";
module.exports["characters__close"] = "_characters__close_a9fe0b";

},{}],"1AiNH":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('hjDlF') + "icons8-удалить.9dbf3989.svg" + "?" + Date.now();
...
},{}],"e6GWD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../../constants/root":"cKJfz","./Notification.css":"9RUSj","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","./Img/icons8-удалить.svg":"ZivJY"}],"9RUSj":[function(require,module,exports) {
module.exports["notification__container"] = "_notification__container_6dfd0a";
module.exports["notification__close"] = "_notification__close_6dfd0a";
module.exports["notification__text"] = "_notification__text_6dfd0a";

},{}],"ZivJY":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('hjDlF') + "icons8-удалить.dd68797c.svg" + "?" + Date.now();

},{"./helpers/bundle-url":"chiK4"}],"gcdXF":[function(require,module,exports) {

},{}]},["lBB98","hD4hw"], "hD4hw", "parcelRequirea407")
